...
class TestFitnessDataLoader:
    ...
    def setup_method(self):
        ...
        self.sample_exp_data = [
            ["expName", "expDesc", "expDescLong", "media", "temperature", "pH", "aerobic", "condition_1", "concentration_1", "units_1", "expGroup"],
            ["cond1", "Condition 1", "Long description 1", "LB", "30", "7.0", "True", "glucose", "10", "mM", "carbon"],
            ["cond2", "Condition 2", "Long description 2", "M9", "37", "7.5", "False", "salt", "100", "mM", "stress"],
            ["cond3", "Condition 3", "Long description 3", "LB", "25", "6.5", "True", "", "", "", "control"]
        ]
    ...
    def test_thread_safety(self):
        ...
        assert all(result == results[0] for result in results)  # All results should be consistent
...
class TestModuleDataLoader:
    ...
    def setup_method(self):
        ...
        self.sample_modules_data = [
            ["module", "locus_tag", "gene_weight", "product", "Description", "Preferred_name", "Protein names", "Gene Ontology (GO)"],
            ["1", "Atu0001", "0.8", "Product 1", "Description 1", "Gene1", "Protein 1", "GO:0001"],
            ["1", "Atu0002", "0.6", "Product 2", "Description 2", "Gene2", "Protein 2", "GO:0002"],
            ["2", "Atu0003", "0.9", "Product 3", "Description 3", "Gene3", "Protein 3", "GO:0003"]
        ]
    ...
    def test_cache_clearing(self):
        ...
        loader.load_data()
        initial_results = loader.search_modules_by_name("Module")
